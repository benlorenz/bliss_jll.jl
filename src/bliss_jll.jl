...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import bliss_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("508c9074-7a14-5c94-9582-3d4bc1871065"))
platforms = [Pkg.Artifacts.unpack_platform(e, "bliss", artifacts_toml) for e in artifacts["bliss"]]
...
if best_platform === nothing
    @debug("Unable to load bliss; unsupported platform $(triplet(platform_key_abi()))")
else
